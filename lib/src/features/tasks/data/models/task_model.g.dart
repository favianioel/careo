...
void _taskModelSerialize(
  ...
  writer.writeLong(offsets[3], object.relatedPersonId);
...
TaskModel _taskModelDeserialize(
  ...
  object.relatedPersonId = reader.readLongOrNull(offsets[3]);
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition>
      relatedPersonIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'relatedPersonId',
        value: value,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByRelatedPersonId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relatedPersonId', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByRelatedPersonIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByRelatedPersonId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relatedPersonId', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByRelatedPersonIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'relatedPersonId', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByRelatedPersonId() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int?, QQueryOperations> relatedPersonIdProperty() {
    return QueryBuilder.apply(this, (query) {
